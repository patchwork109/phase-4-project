    ...
    <div>
      <Container className="aboutPage">
        <Row>
          ...
          <h5><p>Welcome to Fry Me To The Moon, where we take your taste buds on a journey to the stars with our unique outer space-themed French fries!
</p>
<p>
Our company was founded by a group of food enthusiasts who wanted to create a one-of-a-kind dining experience.
 ...
 That's why we decided to create a menu that brings the wonder and excitement of exploring the galaxy to your plate.</p>
<p>At Fry Me To The Moon, we believe that good food should be fun and exciting. That's why we put so much effort into crafting the perfect space-themed fries. 
